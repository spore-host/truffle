...
# hygiene test package (which must stay hermetic and stdlib-only).
# TestActionsArePinnedToSHAs enforces the offline half: every pin is a 40-hex SHA
# with an exact vX.Y.Z comment.
#
